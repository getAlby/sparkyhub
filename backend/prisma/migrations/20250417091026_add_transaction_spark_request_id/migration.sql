/*
  ...
  - Added the required column `spark_request_id` to the `Transaction` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Transaction" (
    ...
    "spark_request_id" TEXT NOT NULL,
...
INSERT INTO "new_Transaction" ("amount_msat", "appId", "created_at", "description", "expires_at", "fees_paid_msat", "id", "invoice", "payment_hash", "settled_at", "state", "type", "userId") SELECT "amount_msat", "appId", "created_at", "description", "expires_at", "fees_paid_msat", "id", "invoice", "payment_hash", "settled_at", "state", "type", "userId" FROM "Transaction";
